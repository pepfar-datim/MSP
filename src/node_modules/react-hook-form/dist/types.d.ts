...
export declare type OnSubmit<FormValues extends FieldValues> = (data: FormValues, e: React.SyntheticEvent | ReactNative.GestureResponderEvent) => void | Promise<void>;
