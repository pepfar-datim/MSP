...
export default function useForm<FormValues extends FieldValues = FieldValues>({ mode, reValidateMode, validationSchema, defaultValues, validationFields, nativeValidation, submitFocusError, validationSchemaOption, }?: Options<FormValues>): {
    ...
    handleSubmit: (callback: OnSubmit<FormValues>) => (e: React.SyntheticEvent<Element, Event> | ReactNative.GestureResponderEvent) => Promise<void>;
    watch: {
        (): FormValues;
    ...
    setValue: (name: FieldName<FormValues>, value: FormValues[FieldName<FormValues>], shouldValidate?: boolean) => void | Promise<boolean>;
